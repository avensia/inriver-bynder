    ...
    public abstract class Extension
    {
        ...
        public Dictionary<string, string> DefaultSettings
        {
            get
            {
                ...
                settings.Add(Config.Settings.PropertySetMap, @"{ property_name1: { inRiverFieldId: ""ResourceFieldId1"", cvlMapping: { CvlKey1: ""PropertyValue1"", CvlKey2: ""PropertyValue2"", CvlKey3: ""PropertyValue3"" }}, property_name2: { inRiverFieldId: ""ResourceFieldId2"", culture: ""en"" }}");
